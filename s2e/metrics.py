...
class CorefEvaluator(object):
    ...
    def detailed_metric(self):
        return {
            "muc": {
                "r": self.evaluators[0].get_recall() *100,
                "p": self.evaluators[0].get_precision() *100,
                "f": self.evaluators[0].get_f1() *100
            },
            "bcub": {
                "r": self.evaluators[1].get_recall() *100,
                "p": self.evaluators[1].get_precision() *100,
                "f": self.evaluators[1].get_f1() *100
            },
            "ceafe": {
                "r": self.evaluators[2].get_recall() *100,
                "p": self.evaluators[2].get_precision() *100,
                "f": self.evaluators[2].get_f1() *100
            }
        }
