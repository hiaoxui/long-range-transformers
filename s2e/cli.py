...
def parse_args():
    ...
    parser.add_argument(
        "--pm",
        type=str,
        help="Path to pytorch_model.bin for evaluation",
    )
    parser.add_argument(
        "-m",
    ...
    parser.add_argument('--segment', default=None, type=int)
    parser.add_argument('--use_global', action='store_true')
    parser.add_argument('--mem', default=0, type=int)
    parser.add_argument("--checkpoint", action='store_true')
    parser.add_argument('--performer', action='store_true', help="use performer?")
    parser.add_argument('--no_load', action='store_true', help="Do not load pretrained parameters.")
    ...
    parser.add_argument(
        "-f", action="store_true", help="Overwrite the content of the output directory"
    )
    parser.add_argument(
        "-r", action="store_true", help="Overwrite the content of the output directory"
    )
