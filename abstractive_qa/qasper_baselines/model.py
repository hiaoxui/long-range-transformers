...
class QasperBaseline(Model):
    def __init__(
        ...
        **kwargs
        ...
        self.transformer = Seq2Seq.get_enecoder_decoder_model(max_length=segment_length)
        self.use_global = True if use_global == 1 else False
    ...
    def forward(
        ...
        output = self.transformer(
            ...
            global_attention_mask=global_attention_mask if self.use_global else None,
            labels=answer_ids,
            use_cache=False,
            return_dict=True,
