...
def get_args():
    ...
    parser.add_argument('--triviaqa_file', help='Triviaqa file', default="/Users/yukunfeng/PycharmProjects/longformer/triviaqa-rc/qa/wikipedia-train.json")
    parser.add_argument('--squad_file', help='Squad file', default="/Users/yukunfeng/PycharmProjects/longformer/triviaqa-squad-train")
    parser.add_argument('--wikipedia_dir', help='Wikipedia doc dir', default="/Users/yukunfeng/PycharmProjects/longformer/triviaqa-rc/evidence/wikipedia")
    parser.add_argument('--web_dir', help='Web doc dir', default="/Users/yukunfeng/PycharmProjects/longformer/triviaqa-rc/evidence/web")

    parser.add_argument('--seed', default=10, type=int, help='Random seed')
    parser.add_argument('--max_num_tokens', default=8192, type=int, help='Maximum number of tokens from a document')
